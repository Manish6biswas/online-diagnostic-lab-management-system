		...
		<div class="row">
			<div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="mobnum" name="mobnum" maxlength="10" pattern="[0-9]+" required="" pattern="[0-9]{10}">
              </div>
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" required="true">
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" id="aptdate" required=""min="2023-02-07" name="aptdate">
							</div>
              <div class="form-group">
